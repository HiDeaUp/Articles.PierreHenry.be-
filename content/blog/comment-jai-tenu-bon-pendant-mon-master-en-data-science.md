+++
title = "Comment j’ai tenu bon pendant mon master en data science"
slug = "comment-jai-tenu-bon-pendant-mon-master-en-data-science"
date = "2026-08-02T21:38:25.311665+10:00"
draft = false
description = "Il arrive un moment où tout paraît trop lourd, où l’envie d’abandonner devient presque irrésistible. J’ai ressenti cela à plusieurs reprises pendant mon master en data science : la difficulté des s..."
summary = "Il arrive un moment où tout paraît trop lourd, où l’envie d’abandonner devient presque irrésistible. J’ai ressenti cela à plusieurs reprises pendant mon master en data science : la difficulté des s..."
tags = ["data science", "gestion du stress", "master", "persévérance", "tech", "études supérieures"]
priority = true
priority_topics = ["tech"]
original_title = "Ce que personne ne t’a dit pour vraiment incarner ton idéal"
source_medium = "https://medium.com/@phenrysay/1e29ab831c0a"
...
Ma semaine type :
- Du lundi au vendredi : 2 heures d’étude par jour.
- Le week-end : 6 heures par jour, parfois un peu moins.
...
Pour aller plus loin dans la construction de ton idéal et découvrir d’autres outils concrets, retrouve-moi sur [mon livre](https://livre.ph7.me) ou inscris-toi à [ma liste de contacts](https://contacts.ph7.me).
