+++
title = "Comment Miss Snap a transformé ma façon de vivre mes projets"
slug = "comment-miss-snap-a-transforme-ma-facon-de-vivre-mes-projets"
date = "2026-08-09T15:13:31.910540+10:00"
draft = false
description = "Un matin, assis devant mon ordinateur avec un café, j’ai ressenti ce mélange d’excitation et de satisfaction qui n’apparaît que lorsqu’on avance sur un projet qui compte vraiment. Ce jour là, je tr..."
summary = "Un matin, assis devant mon ordinateur avec un café, j’ai ressenti ce mélange d’excitation et de satisfaction qui n’apparaît que lorsqu’on avance sur un projet qui compte vraiment. Ce jour là, je tr..."
tags = ["développement personnel", "gestion de projet", "habitudes", "motivation", "productivité", "tech"]
priority = true
priority_topics = ["tech"]
original_title = "Comment réaliser son rêve et des projets épanouissants"
source_medium = "https://medium.com/@phenrysay/bea5019a2ed7"
...
Un matin, assis devant mon ordinateur avec un café, j’ai ressenti ce mélange d’excitation et de satisfaction qui n’apparaît que lorsqu’on avance sur un projet qui compte vraiment. Ce jour-là, je travaillais sur une mise à jour de mon application Miss Snap. Rien d’extraordinaire en apparence : quelques lignes de code, des ajustements. Pourtant, derrière ces gestes, il y a une conviction profonde. La vie est trop courte pour s’ennuyer ou pour se contenter de projets qui ne nous ressemblent pas.

Miss Snap est une application que j’ai créée pour suivre ce que je mange et bois. À chaque café, repas ou en-cas, je prends une photo. L’application stocke tout automatiquement dans le cloud, analyse la quantité d’aliments, distingue ce qui est bon pour la santé de ce qui l’est moins, et me donne un historique sur plusieurs années. En un clin d’œil, je vois si je consomme trop d’aliments ultra-transformés ou si je devrais augmenter la part de produits frais.
...
Créer un projet épanouissant, c’est possible
...
La vie est trop courte pour remettre à demain ce qui peut te rendre heureux aujourd’hui. Lance-toi dans ce projet qui te fait vibrer, même si cela te semble insignifiant au début. C’est la régularité, plus que l’intensité, qui finit par porter ses fruits.

---

Pour aller plus loin dans l’amélioration de ton quotidien, découvre [ma formation Belle Vie](https://methodes.ph7.me/belle-vie-la-formation-sur-mesure) ou inscris-toi à [ma liste de contacts](https://contacts.ph7.me) pour recevoir mes conseils et ressources.
